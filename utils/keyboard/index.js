    ...
    var t = {
        ...
        1034: function (t, e, n) {
          ...
          t.exports = a.correct
            ...
            : function (t) {
                return a.correct || !i(u, t) || r(t, "flags")
                  ? t.flags
                  : o(s, t);
              };
        },
        ...
        1088: function (t, e, n) {
          ...
          t.exports = function (t, e, n, a, h, y, P) {
            ...
            return (
              (i && !P) || N[w] === R || p(N, w, R, { name: h }), (v[e] = R), C
            );
          };
        },
        1181: function (t, e, n) {
            ...
            return [
              ...
              function (t) {
                ...
                for (var f, y = [], g = 0; null !== (f = h(o, r)); ) {
                  var m = c(f[0]);
                  (y[g] = m),
                    "" === m && (o.lastIndex = d(r, u(o.lastIndex), l)),
                    g++;
                }
                return 0 === g ? null : y;
              },
              ...
              return [
                ...
                function (t, r) {
                  ...
                  var y,
                    x = p(m(a)),
                    I = -1 !== k(x, "g");
                  I && ((y = -1 !== k(x, "u")), (a.lastIndex = 0));
                  for (
                    var C, A = [];
                    null !== (C = b(a, s)) && (S(A, C), I);

                  ) {
                    "" === p(C[0]) && (a.lastIndex = v(s, d(a.lastIndex), y));
                  }
                  for (var M, D = "", T = 0, N = 0; N < A.length; N++) {
                    for (
                      var j,
                        R = p((C = A[N])[0]),
                        L = w(E(f(C.index), s.length), 0),
                        B = [],
                        K = 1;
                      K < C.length;
                      K++
                    )
                      S(B, void 0 === (M = C[K]) ? M : String(M));
                    var F = C.groups;
                    if (h) {
                      var _ = O([R], B, L, s);
                      void 0 !== F && S(_, F), (j = p(o(r, void 0, _)));
                    } else j = g(R, s, L, B, F, r);
                    L >= T && ((D += P(s, T, L) + j), (T = L + R.length));
                  }
                  return D + P(s, T);
                },
              ];
              ...
              matchAll: function (t) {
                ...
                if (d(t)) {
                  ...
                  if (
                    ...
                    return r(o, t, a);
                } else if (j) return N(a, t);
                return (
                  (n = l(a)), (i = new RegExp(t, "g")), S ? r(L, i, n) : i[k](n)
                );
              },
            }
          ),
                  ...
                  ? ("{enter}" !== t && "{numpadenter}" !== t) ||
                    ...
                    ? t.includes("numpad") &&
                      ...
                      : t.includes("{") ||
                        t.includes("}") ||
                        (s = this.addStringAt.apply(this, [s, t].concat(a)))
                    : (s = this.addStringAt.apply(this, [s, "\n"].concat(a)))
                  : (s = this.addStringAt.apply(this, [s, "\t"].concat(a))),
                  ...
                  o[i].forEach(function (t) {
                    var e,
                      ...
                      r = function () {
                        ...
                        return (
                          Object.defineProperty(t, "target", { value: o }), t
                        );
                      };
            ...
            if (
              ...
              if (
                ...
                (this.candidateBox = this.options.enableLayoutCandidates
                  ? new O({ utilities: this.utilities, options: this.options })
                  : null),
                !this.keyboardDOM)
              )
                throw (
                  ...
                  (t.split(" ").forEach(function (o) {
                    e.split(" ").forEach(function (e) {
                      ...
                      n.options.buttonTheme.map(function (t) {
                        ...
                        r ||
                          n.options.buttonTheme.push({ class: e, buttons: t });
                    });
                  }),
                  this.render());
              },
            ...
            },
            {
              ...
              value: function () {
                window.oncontextmenu = function (t) {
                  var e;
                  if (
                    null !== (e = t.target.classList) &&
                    void 0 !== e &&
                    e.contains("hg-button")
                  )
